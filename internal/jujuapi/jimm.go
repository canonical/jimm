...
func init() {
	facadeInit["JIMM"] = func(r *controllerRoot) []int {
		...
		addServiceAccountCredentialMethod := rpc.Method(r.AddServiceAccountCredential)
		...
		r.AddMethod("JIMM", 4, "AddServiceAccountCredential", addServiceAccountCredentialMethod)
