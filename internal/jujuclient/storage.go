...
func (c Connection) ListFilesystems(machines []string) ([]jujuparams.FilesystemDetailsListResult, error) {
...
func (c Connection) ListVolumes(machines []string) ([]jujuparams.VolumeDetailsListResult, error) {
	return storage.NewClient(&c).ListVolumes(machines)
}

// ListStorageDetails lists all storage.
func (c Connection) ListStorageDetails() ([]jujuparams.StorageDetails, error) {
