...
type JIMM struct {
	...
	DefaultCloud_                      func(ctx context.Context, u *openfga.User) (names.CloudTag, error)
...
func (j *JIMM) DefaultCloud(ctx context.Context, u *openfga.User) (names.CloudTag, error) {
	if j.DefaultCloud_ == nil {
		return names.CloudTag{}, errors.E(errors.CodeNotImplemented)
	}
	return j.DefaultCloud_(ctx, u)
}
