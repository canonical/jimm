...
CONTROLLER_NAME="$CONTROLLER_NAME" CLIENT_CREDENTIAL_NAME="$CLIENT_CREDENTIAL_NAME" CUSTOM_CONTROLLER_HOSTNAME="$CUSTOM_CONTROLLER_HOSTNAME" "$(dirname "${BASH_SOURCE[0]}")/add-controller.sh"
