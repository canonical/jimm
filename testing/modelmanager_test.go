...
import (
	...
	jimmparams "github.com/canonical/jimm/v3/pkg/api/params"
...
func (s *modelE2EManagerSuite) TestCreateModelOnTargetController(c *gc.C) {
	conn := s.Open(c, nil, "bob", nil)
	defer conn.Close()
	...
	var mi jujuparams.ModelInfo
	err := conn.APICall("JIMM", 4, "", "AddModelToController", jimmparams.AddModelToControllerRequest{
